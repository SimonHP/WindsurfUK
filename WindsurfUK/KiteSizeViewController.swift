...
class KiteSizeViewController: UIViewController {
    ...
    @IBAction func MarketingButtonPressed(_ sender: Any) {UIApplication.shared.open(URL(string:"http://www.surfladle.co.uk/")!as URL, options :[:], completionHandler: nil)
